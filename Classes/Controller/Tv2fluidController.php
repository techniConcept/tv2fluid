...
namespace TC\Tv2fluid\Controller;
 ...
 ***************************************************************/
use TC\Tv2fluid\Service\ConvertMultilangContentHelper;
use TC\Tv2fluid\Service\FixSortingHelper;
use TC\Tv2fluid\Service\MigrateContentHelper;
use TC\Tv2fluid\Service\MigrateFceHelper;
use TC\Tv2fluid\Service\ReferenceElementHelper;
use TC\Tv2fluid\Service\SharedHelper;
use TC\Tv2fluid\Service\UnreferencedElementHelper;
use TYPO3\CMS\Extbase\Mvc\Controller\ActionController;

/**
 * TV Tv2fluid Backend Controller
 */
class Tv2fluidController extends ActionController
{

    /**
     * UnreferencedElementHelper
     *
     * @var UnreferencedElementHelper
     */
     ...
     *
     * @param UnreferencedElementHelper $unreferencedElementHelper
     * @return void
     */
    public function injectUnreferencedElementHelper(UnreferencedElementHelper $unreferencedElementHelper)
    {
     ...
     *
     * @param ReferenceElementHelper $referenceElementHelper
     * @return void
     */
    public function injectReferenceElementHelper(ReferenceElementHelper $referenceElementHelper)
    {
     ...
     *
     * @param MigrateFceHelper $migrateFceHelper
     * @return void
     */
    public function injectUpdateFceHelper(MigrateFceHelper $migrateFceHelper)
    {
     ...
     *
     * @param MigrateContentHelper $migrateContentHelper
     * @return void
     */
    public function injectContentFceHelper(MigrateContentHelper $migrateContentHelper)
    {
        $this->migrateContentHelper = $migrateContentHelper;
    }

    /**
     * @var FixSortingHelper
     */
     ...
     *
     * @param FixSortingHelper $fixSortingHelper
     * @return void
     */
    public function injectFixSortingHelper(FixSortingHelper $fixSortingHelper)
    {
    ...
    /**
     * @var ConvertMultilangContentHelper
     */
     ...
     * DI for shared helper
     *
     * @param ConvertMultilangContentHelper $convertMultilangContentHelper
     * @return void
     */
    public function injectConvertMultilangContentHelper(ConvertMultilangContentHelper $convertMultilangContentHelper)
    {
